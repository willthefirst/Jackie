...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		options = {
			...
			lifespan: 999*999,			// 15 seconds before it is automatically destroyed
		...
		intl = {
			...
			en_us: 'To watch our little story, add this app to your homescreen: tap %icon and then <strong>Add to Home Screen</strong>.',
